import { UseCase, SalesInquirySchema, ServiceAppointmentSchema, SupportTicketSchema } from './types';
...
export const playbooks: Record<UseCase, Playbook> = {
  SALES: {
    useCase: 'SALES',
    name: 'Sales Inquiry',
...
export function getPlaybook(useCase: UseCase): Playbook {
  return playbooks[useCase];
}
